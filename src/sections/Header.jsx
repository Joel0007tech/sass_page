...
const NavLink = ({ title }) => (
  <LinkScroll
    ...
    transition-colors duration-500 cursor-pointer hover:text-p1
    max-lg:my-4 max-lg:h-5"
  >
    {title}
  </LinkScroll>
);
      ...
      >
        ...
        <div
          className={clsx(
            ...
            islink ? "max-lg:opacity-100" : "max-lg:pointer-events-none",
          )}
        >
          <div
            className="max-lg:relative max-lg:flex
                max-lg:flex-col ma-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden
                sidebar-before max-md:px-4"
          >
            <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
              <ul
                className="flex max-lg:block
                        max-lg:px-12 max-lg:pt-20"
              >
                <li className="nav-li">
        ...
        >
          <img
            src={`/src/images/${islink ? "close" : "magic"}.svg`}
            alt="icon"
